...
describe("(core) octofetch tests", () => {
    ...
    test("'query' should add the correct query", async () => {
        ...
        const queryPath =
            path + `?${queryName}=${encodeURIComponent(queryValue)}`;
